...
This shows you all active users. If you ever notice a login you don't recognize — that's your first sign that someone might've accessed your machine remotely.
...
If you see multiple failed logins from the same IP address — that could be a brute-force attack.
...
This shows which IPs your system is talking to. If you find unknown addresses or strange open ports, that's suspicious — attackers often open hidden communication channels.
...
Sometimes malware hides as a background process — spotting something you didn't start yourself is a good habit.
...
This helps you detect system file changes made within the last day — something that usually happens right after a hack attempt.
